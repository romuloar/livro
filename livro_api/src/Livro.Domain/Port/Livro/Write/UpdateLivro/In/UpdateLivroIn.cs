...
namespace Livro.Domain.Port.Livro.Write.UpdateLivro.In;

public class UpdateLivroIn : RomBaseDomain
{
    ...
    public List<LivroValorUpdateIn> Valores { get; set; } = new();
}

public class LivroValorUpdateIn : RomBaseDomain
{
